...
<body style="background-color: #6a648f; background-image: none;">
   ...
   <div class="container" style="margin:auto; min-width:875px; ">
  <div class="row gx-5 offset-md-2 align-middle">

    <div class="col-sm-6" style="margin-top:40px; float:right;">
<img src="imgs/contactformportraitcircle.png" height="350px" class="image-fluid" >    </div>
