...
<body>
    ...
    <div class="videos-container">
        <div class="video-wrapper video embed-responsive">
          <p id = "selfie">
<img src="/BlackTalon/imgs/contactformportrait.png" height="50%" width="50%"></div>
        <div class="contact ">
...
<div>
      ...
      <div class="g-recaptcha" data-sitekey="6LcIOykmAAAAAI1_aKVEA2ozWtZgSU68o4lRe5ex"></div>
</div>
    ...
    <div class = "container-fluid footer">       
        <p>Copyright © 2023 Shannon Miller Films - All Rights Reserved.</p>
        <span id = "arrow">
            <button class="fa-sharp fa-solid fa-arrow-up-long fa-lg arrow btn bg-transparent arrowSet"  onclick="window.scrollTo(0, 0)">                
            </button>            
        </span>
    </div>
    </body>
